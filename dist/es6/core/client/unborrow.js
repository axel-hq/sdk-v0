...
void null;
const action_class = actions_info["unborrow"].action_class;
const assert_pcols = dynamic_protocol_assert[action_class];
export function unborrow(opts) {
    check_provider(this);
    return two1_run(this, "unborrow", opts);
}
export async function safe_unborrow(opts) {
    check_provider(this);
    assert_request(opts, assert_pcols);
    const full = await promote_request(this, opts);
    return two1_run(this, "unborrow", full);
}
