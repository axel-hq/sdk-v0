...
export declare function unborrow(this: AxelCoreClient, opts: two1_req_full<pcols>): Promise<hex_string[]>;
export declare function safe_unborrow(this: AxelCoreClient, opts: unknown): Promise<hex_string[]>;
export {};
