...
type endpoint = "unborrow";
type action_class = actions_info[endpoint]["action_class"];
type allowed_protocols = protocols_of<action_class>;
export type full_unborrow_request = two1_req_full<allowed_protocols>;
export type partial_unborrow_request = two1_req_partial<allowed_protocols>;
export type unborrow = {
    (this: AxelClientInstance, opts: full_unborrow_request): Promise<hex_string[]>;
};
export type safe_unborrow = {
